...
func _ready():
	...
	$PanelContainer.set_title("Уровень 11")
...
func check_completed():
	var f1 = global_pivot($BLOCKS/TextureButton) == $POSITIONS/Position2D17.global_position
	var f2 = global_pivot($BLOCKS/TextureButton2) == $POSITIONS/Position2D5.global_position
	var f3 = global_pivot($BLOCKS/TextureButton3) == $POSITIONS/Position2D15.global_position
	var f4 = global_pivot($BLOCKS/TextureButton4) == $POSITIONS/Position2D12.global_position
	var f5 = global_pivot($BLOCKS/TextureButton5) == $POSITIONS/Position2D13.global_position

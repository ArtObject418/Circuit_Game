...
func _ready():
	...
	$PanelContainer.set_title("Уровень 5")
	...
	$Teoretic.set_description("Резистор - элемент цепи создающий сопротивление (R) на участке\n\nЭтот резистор имеет сопротивление 5 Ом")
...
func check_completed():
	...
	var f3 = global_pivot($BLOCKS/TextureButton3) == $POSITIONS/Position2D17.global_position
	var f4 = global_pivot($BLOCKS/TextureButton4) in [$POSITIONS/Position2D2.global_position, $POSITIONS/Position2D4.global_position]
	var f5 = global_pivot($BLOCKS/TextureButton5) in [$POSITIONS/Position2D2.global_position, $POSITIONS/Position2D4.global_position]

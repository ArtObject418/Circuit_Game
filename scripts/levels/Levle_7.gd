...
func _ready():
	...
	$PanelContainer.set_title("Уровень 7")
	...
	$Teoretic.set_description("Напряжение на участке (U) - это разность потенциалов входа и выхода\n\nЗдесь напряжение - 5B")
...
func check_completed():
	var f1 = global_pivot($BLOCKS/TextureButton) in [$POSITIONS/Position2D2.global_position, $POSITIONS/Position2D4.global_position, $POSITIONS/Position2D17.global_position, $POSITIONS/Position2D19.global_position]
	var f2 = global_pivot($BLOCKS/TextureButton2) == $POSITIONS/Position2D22.global_position
	var f3 = global_pivot($BLOCKS/TextureButton3) in [$POSITIONS/Position2D2.global_position, $POSITIONS/Position2D4.global_position, $POSITIONS/Position2D17.global_position, $POSITIONS/Position2D19.global_position]
	var f4 = global_pivot($BLOCKS/TextureButton4) in [$POSITIONS/Position2D2.global_position, $POSITIONS/Position2D4.global_position, $POSITIONS/Position2D17.global_position, $POSITIONS/Position2D19.global_position]
	var f5 = global_pivot($BLOCKS/TextureButton5) in [$POSITIONS/Position2D2.global_position, $POSITIONS/Position2D4.global_position, $POSITIONS/Position2D17.global_position, $POSITIONS/Position2D19.global_position]

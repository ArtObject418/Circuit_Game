...
func _ready():
	...
	$PanelContainer.set_title("Уровень 3")
	...
	$Teoretic.set_description("Цепь может иметь несколько выходов")
...
func check_completed():
	...
	var f2 = global_pivot($BLOCKS/TextureButton2) in [$POSITIONS/Position2D2.global_position, $POSITIONS/Position2D4.global_position]
	var f3 = global_pivot($BLOCKS/TextureButton3) == $POSITIONS/Position2D12.global_position
	var f4 = global_pivot($BLOCKS/TextureButton4) == $POSITIONS/Position2D3.global_position

...
func _ready():
	...
	$PanelContainer.set_title("Уровень 12")
	...
	$Teoretic.set_description("Посмотри какие харастеристики имеет цепь")
...
func check_completed():
	var f1 = global_pivot($BLOCKS/TextureButton) == $POSITIONS/Position2D19.global_position
	...
	var f4 = global_pivot($BLOCKS/TextureButton4) == $POSITIONS/Position2D21.global_position
	var f5 = global_pivot($BLOCKS/TextureButton5) == $POSITIONS/Position2D18.global_position
